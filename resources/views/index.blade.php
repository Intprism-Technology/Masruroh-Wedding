...
<body>
    ...
    <section
        ...
        <div class="title text-center">
            <div data-aos="fade-up" data-aos-delay="200">
                ...
                <br>
                <button type=button class="btn btn-md btn-secondary open_invitation px-5 mt-5" style="z-index:100">Open
                    Invitation</button>
            </div>
        </div>
    </section>
    ...
    <section class="couple" id="couple">
        ...
        <div class="container" data-aos="fade-up">
            ...
            Maha suci Allah SWT yang telah menciptakan makhluk-Nya berpasang-pasangan. <br>Ya Allah, Ridhoilah pernikahan kami:<br><br>
        </div>
